...
class LargeTheatreMaximal extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final onFilteredCategoriesChanged =
        (List<SeatsioCategory> categories) => print("filtered categories changed: ${categories.map((c) => c.label)}");
